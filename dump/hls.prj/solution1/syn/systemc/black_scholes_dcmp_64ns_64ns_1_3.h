...
#ifndef __black_scholes_dcmp_64ns_64ns_1_3__HH__
#define __black_scholes_dcmp_64ns_64ns_1_3__HH__
#include "ACMP_dcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(black_scholes_dcmp_64ns_64ns_1_3) {
    ...
    SC_CTOR(black_scholes_dcmp_64ns_64ns_1_3):  ACMP_dcmp_U ("ACMP_dcmp_U") {
        ACMP_dcmp_U.clk(clk);
