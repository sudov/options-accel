...
#ifndef _black_scholes_rand_uint32_HH_
#define _black_scholes_rand_uint32_HH_

#include "systemc.h"
#include "AESL_pkg.h"

#include "black_scholes_rand_uint32_mt_kk.h"

namespace ap_rtl {

struct black_scholes_rand_uint32 : public sc_module {
    // Port declarations 8
    sc_in_clk ap_clk;
    ...
    // Module declarations
    black_scholes_rand_uint32(sc_module_name name);
    SC_HAS_PROCESS(black_scholes_rand_uint32);

    ~black_scholes_rand_uint32();

    sc_trace_file* mVcdFile;

    black_scholes_rand_uint32_mt_kk* mt_kk_U;
    black_scholes_rand_uint32_mt_kk* mt_kkp1_U;
    black_scholes_rand_uint32_mt_kk* mt_kkpm_U;
