...
#ifndef __gaussrand2_fptrunc_64ns_32_3__HH__
#define __gaussrand2_fptrunc_64ns_32_3__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(gaussrand2_fptrunc_64ns_32_3) {
    ...
    SC_CTOR(gaussrand2_fptrunc_64ns_32_3):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
