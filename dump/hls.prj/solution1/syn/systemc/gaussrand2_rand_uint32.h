...
#ifndef _gaussrand2_rand_uint32_HH_
#define _gaussrand2_rand_uint32_HH_

#include "systemc.h"
#include "AESL_pkg.h"

#include "gaussrand2_rand_uint32_mt_kk.h"

namespace ap_rtl {

struct gaussrand2_rand_uint32 : public sc_module {
    // Port declarations 7
    sc_in_clk ap_clk;
    ...
    // Module declarations
    gaussrand2_rand_uint32(sc_module_name name);
    SC_HAS_PROCESS(gaussrand2_rand_uint32);

    ~gaussrand2_rand_uint32();

    sc_trace_file* mVcdFile;

    gaussrand2_rand_uint32_mt_kk* mt_kk_U;
    gaussrand2_rand_uint32_mt_kk* mt_kkp1_U;
    gaussrand2_rand_uint32_mt_kk* mt_kkpm_U;
