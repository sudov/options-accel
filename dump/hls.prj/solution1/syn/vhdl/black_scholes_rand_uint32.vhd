...
entity black_scholes_rand_uint32 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of black_scholes_rand_uint32 is 
    ...
    component black_scholes_rand_uint32_mt_kk IS
    generic (
        DataWidth : INTEGER;
...
begin
    mt_kk_U : component black_scholes_rand_uint32_mt_kk
    generic map (
        DataWidth => 64,
        AddressRange => 624,
        AddressWidth => 10)
    ...
    mt_kkp1_U : component black_scholes_rand_uint32_mt_kk
    generic map (
        DataWidth => 64,
        AddressRange => 624,
        AddressWidth => 10)
    ...
    mt_kkpm_U : component black_scholes_rand_uint32_mt_kk
    generic map (
        DataWidth => 64,
        AddressRange => 624,
        AddressWidth => 10)
