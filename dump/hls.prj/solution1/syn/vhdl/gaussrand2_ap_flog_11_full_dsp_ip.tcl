...
create_ip -name floating_point -version 7.0 -vendor xilinx.com -library ip -module_name gaussrand2_ap_flog_11_full_dsp
# BEGIN Vivado Commands 
...
set_property -dict [list CONFIG.a_precision_type Single \
                          ...
                          CONFIG.component_name gaussrand2_ap_flog_11_full_dsp \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips gaussrand2_ap_flog_11_full_dsp] -quiet
# END Vivado Parameters
generate_target {synthesis simulation} [get_files gaussrand2_ap_flog_11_full_dsp.xci]
