; ModuleID = '/home/student/vff6/ece5775/assignments/HighLevelSynth/options-accel/vhls-dut-template/fifo.prj/sol/.autopilot/db/a.o.3.bc'
...
entry:
  ...
  call void @llvm.dbg.value(metadata !{i32* %in_fifo_V}, i64 0, metadata !58)
  call void @llvm.dbg.value(metadata !{i32* %out_fifo_V}, i64 0, metadata !63)
  call void (...)* @_ssdm_op_SpecWire(i32 0, [13 x i8]* @p_str3, [1 x i8]* @p_str4) nounwind, !dbg !65
  call void @llvm.dbg.value(metadata !{i32* %in_fifo_V}, i64 0, metadata !68)
  %tmp_0 = call i32 @_ssdm_op_FifoRead.volatile.i32P(i32* %in_fifo_V), !dbg !72 ; <i32> [#uses=0]
  call void @llvm.dbg.value(metadata !{i32 %tmp_0}, i64 0, metadata !76), !dbg !72
  %cnt_load = load i32* @cnt, align 4, !dbg !77   ; <i32> [#uses=1]
  %tmp = add nsw i32 %cnt_load, -1, !dbg !77      ; <i32> [#uses=2]
  store i32 %tmp, i32* @cnt, align 4, !dbg !77
  call void @llvm.dbg.value(metadata !{i32* %out_fifo_V}, i64 0, metadata !78)
  call void @llvm.dbg.value(metadata !{i32 %tmp}, i64 0, metadata !80), !dbg !83
  call void @_ssdm_op_FifoWrite.volatile.i32P(i32* %out_fifo_V, i32 %tmp), !dbg !85
  ret void, !dbg !86
}
...
!72 = metadata !{i32 85, i32 0, metadata !73, metadata !75}
...
!75 = metadata !{i32 7, i32 0, metadata !66, null}
!76 = metadata !{i32 459008, metadata !73, metadata !"tmp", metadata !9, i32 84, metadata !12} ; [ DW_TAG_auto_variable ]
!77 = metadata !{i32 8, i32 0, metadata !66, null}
!78 = metadata !{i32 462851, metadata !79, metadata !"stream<int>.V", metadata !9, i32 98, metadata !60} ; [ DW_TAG_arg_variable_field ]
!79 = metadata !{i32 459009, metadata !54, metadata !"this", metadata !9, i32 98, metadata !70} ; [ DW_TAG_arg_variable ]
!80 = metadata !{i32 459008, metadata !81, metadata !"tmp", metadata !9, i32 99, metadata !12} ; [ DW_TAG_auto_variable ]
!81 = metadata !{i32 458763, metadata !82, i32 98, i32 0} ; [ DW_TAG_lexical_block ]
!82 = metadata !{i32 458763, metadata !54, i32 98, i32 0} ; [ DW_TAG_lexical_block ]
!83 = metadata !{i32 99, i32 0, metadata !81, metadata !84}
!84 = metadata !{i32 9, i32 0, metadata !66, null}
!85 = metadata !{i32 100, i32 0, metadata !81, metadata !84}
!86 = metadata !{i32 10, i32 0, metadata !66, null}
