...
#pragma line 112 "/opt/xilinx/Vivado_HLS/2012.3/common/technology/autopilot/hls_stream.h"
};
#pragma empty_line
} // namespace hls
...
public: 
inline __attribute__((always_inline)) static void aesl_keep_name_stream_in_fifo(hls::stream< int >& in_fifo) {SSDM_KEEP_name(in_fifo.V, &in_fifo.V); }

};
template< typename __STREAM_T__ >
class aesl_keep_name_class_stream_out_fifo{ 
public: 
inline __attribute__((always_inline)) static void aesl_keep_name_stream_out_fifo(hls::stream< int >& out_fifo) {SSDM_KEEP_name(out_fifo.V, &out_fifo.V); }

};
};
#pragma line 3 "fifo.cpp"
