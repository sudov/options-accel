set moduleName black_scholes_init_by_array
...
set isOneStateSeq 0
set C_modelName black_scholes_init_by_array
set C_modelType { void 0 }
set C_modelArgList { 
	{ mti int 32 regular {pointer 1} {global 1}  }
	{ mt int 64 regular {array 624 { 2 3 } 1 1 } {global 2}  }
}
...
set portList { 
	...
	{ mti sc_out sc_lv 32 signal 0 } 
	{ mti_ap_vld sc_out sc_logic 1 outvld 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "mti", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "mti", "role": "default" }} , 
 	{ "name": "mti_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "mti", "role": "ap_vld" }} , 
...
set Spec2ImplPortList { 
	mti { ap_vld {  { mti out_data 1 32 }  { mti_ap_vld out_vld 1 1 } } }
	mt { ap_memory {  { mt_address0 mem_address 1 10 }  { mt_ce0 mem_ce 1 1 }  { mt_we0 mem_we 1 1 }  { mt_d0 mem_din 1 64 }  { mt_q0 mem_dout 0 64 } } }
}
