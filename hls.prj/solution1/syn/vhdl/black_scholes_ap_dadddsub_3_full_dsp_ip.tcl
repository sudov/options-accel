...
create_ip -name floating_point -version 7.0 -vendor xilinx.com -library ip -module_name black_scholes_ap_dadddsub_3_full_dsp
# BEGIN Vivado Commands 
...
set_property -dict [list CONFIG.a_precision_type Double \
                          ...
                          CONFIG.component_name black_scholes_ap_dadddsub_3_full_dsp \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips black_scholes_ap_dadddsub_3_full_dsp] -quiet
# END Vivado Parameters
generate_target {synthesis simulation} [get_files black_scholes_ap_dadddsub_3_full_dsp.xci]
