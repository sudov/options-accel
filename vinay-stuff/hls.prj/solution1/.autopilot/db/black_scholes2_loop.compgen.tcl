...
set id 1
set name black_scholes2_loop_dadddsub_64ns_64ns_64_5_full_dsp
...
set id 2
set name black_scholes2_loop_dmul_64ns_64ns_64_6_max_dsp
...
set id 4
set name black_scholes2_loop_dcmp_64ns_64ns_1_3
...
set id 5
set name black_scholes2_loop_dsqrt_64ns_64ns_64_31
...
set id 6
set name black_scholes2_loop_dexp_64ns_64ns_64_18_full_dsp
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir I \
    corename rand_number \
    op interface \
    ports { rand_number_address0 { O 14 vector } rand_number_ce0 { O 1 bit } rand_number_q0 { I 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'rand_number'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename store \
    op interface \
    ports { store_address0 { O 14 vector } store_ce0 { O 1 bit } store_we0 { O 1 bit } store_d0 { O 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'store'"
}
}
