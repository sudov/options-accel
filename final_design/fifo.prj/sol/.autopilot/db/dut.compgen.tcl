...
set id 1
set name dut_dmul_64ns_64ns_64_6_max_dsp
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_in_fifo_V \
    op interface \
    ports { in_fifo_V_dout { I 32 vector } in_fifo_V_empty_n { I 1 bit } in_fifo_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_out_fifo_V \
    op interface \
    ports { out_fifo_V_din { O 32 vector } out_fifo_V_full_n { I 1 bit } out_fifo_V_write { O 1 bit } } \
} "
}
