...
#ifndef __dut_dadddsub_64ns_64ns_64_5_no_dsp__HH__
#define __dut_dadddsub_64ns_64ns_64_5_no_dsp__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_dadddsub_64ns_64ns_64_5_no_dsp) {
    ...
    SC_CTOR(dut_dadddsub_64ns_64ns_64_5_no_dsp):  ACMP_dadddsub_U ("ACMP_dadddsub_U") {
