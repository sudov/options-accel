...
#ifndef __BlackScholes_dcmp_64ns_64ns_1_3__HH__
#define __BlackScholes_dcmp_64ns_64ns_1_3__HH__
#include "ACMP_dcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(BlackScholes_dcmp_64ns_64ns_1_3) {
    ...
    SC_CTOR(BlackScholes_dcmp_64ns_64ns_1_3):  ACMP_dcmp_U ("ACMP_dcmp_U") {
        ACMP_dcmp_U.clk(clk);
