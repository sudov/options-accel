...
#ifndef __dut_uitodp_64ns_64_6__HH__
#define __dut_uitodp_64ns_64_6__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_uitodp_64ns_64_6) {
    ...
    SC_CTOR(dut_uitodp_64ns_64_6):  ACMP_uitodp_U ("ACMP_uitodp_U") {
