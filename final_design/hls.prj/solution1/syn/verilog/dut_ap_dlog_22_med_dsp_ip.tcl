...
create_ip -name floating_point -version 7.0 -vendor xilinx.com -library ip -module_name dut_ap_dlog_22_med_dsp
# BEGIN Vivado Commands 
...
set_property -dict [list CONFIG.a_precision_type Double \
                          ...
                          CONFIG.component_name dut_ap_dlog_22_med_dsp \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips dut_ap_dlog_22_med_dsp] -quiet
# END Vivado Parameters
generate_target {synthesis simulation} [get_files dut_ap_dlog_22_med_dsp.xci]
