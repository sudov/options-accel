...
create_ip -name floating_point -version 7.0 -vendor xilinx.com -library ip -module_name BlackScholes_ap_drecip_9_no_dsp
# BEGIN Vivado Commands 
...
set_property -dict [list CONFIG.a_precision_type Double \
                          ...
                          CONFIG.component_name BlackScholes_ap_drecip_9_no_dsp \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips BlackScholes_ap_drecip_9_no_dsp] -quiet
# END Vivado Parameters
generate_target {synthesis simulation} [get_files BlackScholes_ap_drecip_9_no_dsp.xci]
