...
create_ip -name floating_point -version 7.0 -vendor xilinx.com -library ip -module_name BlackScholesWrapper_ap_dsub_3_no_dsp
# BEGIN Vivado Commands 
...
set_property -dict [list CONFIG.a_precision_type Double \
                          ...
                          CONFIG.component_name BlackScholesWrapper_ap_dsub_3_no_dsp \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips BlackScholesWrapper_ap_dsub_3_no_dsp] -quiet
# END Vivado Parameters
generate_target {synthesis simulation} [get_files BlackScholesWrapper_ap_dsub_3_no_dsp.xci]
